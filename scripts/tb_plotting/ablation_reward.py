...
tb_paths = [
    "orch3_framestack_n_4_gray_Rv1_SAC_framestack_4_grayscale_unmasked_1",
    "orch3_framestack_n_4_gray_Rv2_SAC_framestack_4_grayscale_unmasked_1",
    "orch3_framestack_n_4_gray_Rv3_SAC_framestack_4_grayscale_unmasked_1"
]

tb_labels = ["Visual (v1)", "Change in Elements (v2)", "Change in Unseen Elements (v3)"]
...
print(current_dir)
plt.savefig(current_dir + "/ablation_reward.pdf", bbox_inches="tight")
